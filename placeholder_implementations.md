...
| 2 | C Last Run info | High | Define and implement the restore contract before making `resume-last-run` operational. | C now has a read-only backend load path, but restore remains missing. |
