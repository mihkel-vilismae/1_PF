...
> Current checkpoint: `v0.10.66`. The root `full_windows_runner_status.cmd` remains the preferred Windows operator entry point and the terminal UI displays the current repo version.
