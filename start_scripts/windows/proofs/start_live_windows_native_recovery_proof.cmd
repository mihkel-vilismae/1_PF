@echo off
REM Windows live native recovery proof wrapper for PF_login.
...
powershell -NoProfile -ExecutionPolicy Bypass -File "%REPO_ROOT%\start_scripts\run_live_windows_native_recovery_proof.ps1" %*
set "EXIT_CODE=%ERRORLEVEL%"
if not "%EXIT_CODE%"=="0" (
  echo [ERROR] run_live_windows_native_recovery_proof.ps1 failed with exit code %EXIT_CODE%.
  pause
  exit /b %EXIT_CODE%
)
