...
| `2026-04-20_explain-values-source-mode.md` | `Task Doc — Explain Values Source Mode Button` | Add a second topbar button next to Explain controls that toggles a value-source inspection mode. When enabled, the UI highlights live values rather than action… | `implemented` | `unknown` | `unknown` | `uncommitted` | Uncommitted file. |
