...
13. `docs/OLD_DOCS/01_SYSTEM_OVERVIEW.md`
14. `docs/OLD_DOCS/02_SYSTEM_INVARIANTS.md`
15. `docs/OLD_DOCS/03_ARCHITECTURE.md`
16. `docs/OLD_DOCS/04_SINGLE_SOURCE_OF_TRUTH.md`
17. `docs/OLD_DOCS/05_STATE_MACHINE.md`
18. `docs/OLD_DOCS/06_DATABASE_SCHEMA.md`
19. `docs/OLD_DOCS/07_PIPELINE_STAGES.md`
20. `docs/OLD_DOCS/08_WORKERS_AND_OWNERSHIP.md`
21. `docs/OLD_DOCS/09_CRON_AND_WATCHDOG.md`
22. `docs/OLD_DOCS/10_CONCURRENCY_AND_LOCKING.md`
23. `docs/OLD_DOCS/11_LOGGING_AND_EVENT_MODEL.md`
24. `docs/OLD_DOCS/12_STATE_AND_RECOVERY.md`
25. `docs/OLD_DOCS/13_FRONTEND_BACKEND_CONTRACT.md`
26. `docs/OLD_DOCS/14_VERSIONING_AND_CHANGELOG_RULES.md`
27. `docs/OLD_DOCS/18_CANONICAL_BACKEND_CONTRACT_SET.md`
28. `docs/OLD_DOCS/19_BACKEND_RUNTIME_CONTRACT.md`
29. `docs/OLD_DOCS/20_STATE_AND_TRUTH_CONTRACT.md`
30. `docs/OLD_DOCS/21_EXECUTION_AND_RECOVERY_CONTRACT.md`
31. `docs/OLD_DOCS/22_ACCEPTANCE_AND_VALIDATION_CONTRACT.md`
