...
- Reformatted `CHANGELOG.md` into paired date/version entry headings while retaining existing entry content.
- Shortened root `HOW_TO_RUN.md` into a quickstart-focused file and moved the expanded run guidance to `docs/10_runbooks/how_to_run_full_reference.md`.
- Documented the rule that `HOW_TO_RUN.md` must stay short and that default project setups need a root runner/status helper such as `full_windows_runner_status.cmd`.

## 2026-06-22 15:09 EEST
## v0.10.19
...
## DATE_NOT_RECORDED
## v0.10.5 - Upstream documentation audit reconciliation
...
## DATE_NOT_RECORDED
## v0.10.2 - Proofrunner millisecond timing history
...
## DATE_NOT_RECORDED
## v0.10.1 - Windows progress launcher npm executable hotfix
...
## DATE_NOT_RECORDED
## v0.10.0 - Operator-safe iCloud readiness/session checkpoint
...
## DATE_NOT_RECORDED
## v0.8.187 - Real iCloudPD readiness preflight
...
## DATE_NOT_RECORDED
## v0.8.186 - Real geocode provider readiness preflight
...
## DATE_NOT_RECORDED
## v0.8.185 - Proof-runner final-summary test repair
...
## DATE_NOT_RECORDED
## v0.8.184 - Proof-runner handoff instructions
...
## DATE_NOT_RECORDED
## v0.8.183 - Ordered proof-runner documentation
...
## DATE_NOT_RECORDED
## v0.8.182 - Proof runner final readiness summary
...
## DATE_NOT_RECORDED
## v0.8.181 - Proof runner queue ordering contract
...
## DATE_NOT_RECORDED
## v0.8.180 - Raspberry queue docs test alignment
...
## DATE_NOT_RECORDED
## v0.8.179 - Proof runner queue and docs alignment
...
## DATE_NOT_RECORDED
## v0.8.178 - V1 readiness proof command remap
...
## DATE_NOT_RECORDED
## v0.8.177 - iCloud auth readiness diagnostics
...
## DATE_NOT_RECORDED
## v0.8.176 - Geocode provider readiness diagnostics
...
## DATE_NOT_RECORDED
## v0.8.165 - V1 readiness live-data requirements
...
## DATE_NOT_RECORDED
## v0.8.164 - Screen worker non-blocking design proof
...
## DATE_NOT_RECORDED
## v0.8.163 - Regular worker product evidence envelope
...
## DATE_NOT_RECORDED
## v0.8.162 - Regular worker product contract proof
...
## DATE_NOT_RECORDED
## v0.8.161 - Auth checkpoint proof state
...
## DATE_NOT_RECORDED
## v0.8.160 - iCloudPD preflight secret boundary
...
## DATE_NOT_RECORDED
## v0.8.159 - Scheduler host mock status surface
...
## DATE_NOT_RECORDED
## v0.8.158 - Scheduler host boundary OpenSpec
...
## DATE_NOT_RECORDED
## v0.8.157 - Debug fake restore preview
...
## DATE_NOT_RECORDED
## v0.8.156 - Controlled restore action OpenSpec
...
## DATE_NOT_RECORDED
## v0.8.155 - View C read-only wording cleanup
...
## DATE_NOT_RECORDED
## v0.8.154 - View A mode safety proof
...
## DATE_NOT_RECORDED
## v0.8.152 - Debug worker status projection bridge
...
## DATE_NOT_RECORDED
## v0.8.151 - View D status-backed projection
...
## DATE_NOT_RECORDED
## v0.8.150 - Runtime status projection contract
...
## DATE_NOT_RECORDED
## v0.8.149 - Debug runtime registry finalization
...
## DATE_NOT_RECORDED
## v0.8.148 - Debug fake crontab mutation safety
...
## DATE_NOT_RECORDED
## v0.8.84 - Correct Fedora parity package version root
...
## DATE_NOT_RECORDED
## v0.8.54 - Scheduler CLI bootstrap repair and Raspberry cron preflight
...
## DATE_NOT_RECORDED
## v0.8.53 - Raspberry reboot evidence generator
...
## DATE_NOT_RECORDED
## v0.8.52 - Raspberry app-running PASS harness
...
## DATE_NOT_RECORDED
## v0.8.51 - Real worker status/lock instrumentation
...
## DATE_NOT_RECORDED
## v0.8.48 - Raspberry physical power-loss recovery proof
...
## DATE_NOT_RECORDED
## v0.8.47 - Raspberry reboot recovery proof
...
## DATE_NOT_RECORDED
## v0.8.46 - Raspberry app-running status summary
...
## DATE_NOT_RECORDED
## v0.8.45 - Raspberry cron three-worker runtime proof
...
## DATE_NOT_RECORDED
## v0.8.43 - Production GPS/geocode placeholder OpenSpec
...
## DATE_NOT_RECORDED
## v0.8.42 - Raspberry native video playback proof
...
## DATE_NOT_RECORDED
## v0.8.41 - Hermetic View E validation
...
## DATE_NOT_RECORDED
## v0.8.40 - Raspberry native image playback proof
...
## DATE_NOT_RECORDED
## v0.8.39 - Raspberry generated fixture proof
...
## DATE_NOT_RECORDED
## v0.8.38 - Raspberry project-owned launcher skeleton
...
## DATE_NOT_RECORDED
## v0.8.37 - Raspberry local tool checker preflight
...
## DATE_NOT_RECORDED
## v0.8.36 - Endpoint contract OpenSpec extraction
...
## DATE_NOT_RECORDED
## v0.8.35 - Task docs TOC drift repair
...
## DATE_NOT_RECORDED
## v0.8.34 - Runtime proof artifact ignore guard
...
## DATE_NOT_RECORDED
## v0.8.33 - Project status analysis and endpoint inventory report
...
## DATE_NOT_RECORDED
## v0.8.29 - Remove Windows Task Scheduler project scope
...
## DATE_NOT_RECORDED
## v0.8.28 - Superseded Windows Task Scheduler dry-run proof contract
...
## DATE_NOT_RECORDED
## v0.8.25 - Controlled Windows native recovery orchestration
...
## DATE_NOT_RECORDED
## v0.8.21 - Remove media tool bundles from local Git history
...
## DATE_NOT_RECORDED
## v0.8.20 - Large binary commit confirmation rule
...
## DATE_NOT_RECORDED
## v0.8.19 - Untrack vendored Windows FFmpeg bundle
...
## DATE_NOT_RECORDED
## v0.8.18 - Vendor Windows FFmpeg bundle
...
## DATE_NOT_RECORDED
## v0.8.17 - Clean generated video fixture archive tracking
...
## DATE_NOT_RECORDED
## v0.8.16 - GIT WORK artifact confirmation safeguard
...
## DATE_NOT_RECORDED
## v0.8.15 - Video fixture repair handoff snapshot
...
## DATE_NOT_RECORDED
## v0.8.14 - Generated video fixture repair integration
...
## DATE_NOT_RECORDED
## v0.8.13 - Target proof-owned launchers
...
## DATE_NOT_RECORDED
## v0.8.9 - Worker stdout proof parser redaction fix
...
## DATE_NOT_RECORDED
## v0.8.7 - Playback worker native autostart exact-item fix
...
## DATE_NOT_RECORDED
## v0.8.6 - Worker-autostart native playback proof identity fix
...
## DATE_NOT_RECORDED
## v0.8.5 - Windows mpv installer version verification fix
...
## DATE_NOT_RECORDED
## v0.8.4 - Windows mpv installer regex escaping fix
...
## DATE_NOT_RECORDED
## v0.8.2 - Windows mpv auto-install launcher
...
## DATE_NOT_RECORDED
## v0.8.1 - Live Windows native playback proof scaffold
...
## DATE_NOT_RECORDED
## v0.7.33 - 31.05.2026, 12:33:00 EEST
...
## DATE_NOT_RECORDED
## v0.7.32 - 29.05.2026, 22:20:00 EEST
...
## DATE_NOT_RECORDED
## v0.7.31 - 29.05.2026, 22:02:00 EEST
...
## DATE_NOT_RECORDED
## v0.7.30 - 29.05.2026, 20:18:00 EEST
...
## DATE_NOT_RECORDED
## v0.7.29 - 29.05.2026, 19:31:00 EEST
...
## DATE_NOT_RECORDED
## v0.7.28 - 29.05.2026, 17:41:35 EEST
...
## DATE_NOT_RECORDED
## v0.7.22 - 29.05.2026, 18:05:00 EEST
...
## DATE_NOT_RECORDED
## v0.7.21 - 29.05.2026, 17:49:00 EEST
...
## DATE_NOT_RECORDED
## v0.7.20 - 29.05.2026, 17:33:00 EEST
...
## DATE_NOT_RECORDED
## v0.7.19 - 29.05.2026, 17:18:00 EEST
...
## DATE_NOT_RECORDED
## v0.7.18 - 29.05.2026, 17:05:00 EEST
...
## DATE_NOT_RECORDED
## v0.7.17 - 29.05.2026, 16:31:00 EEST
...
## DATE_NOT_RECORDED
## v0.7.16 - 28.05.2026, 20:47:00 EEST
...
## DATE_NOT_RECORDED
## v0.7.15 - 28.05.2026, 13:36:00 EEST
...
## DATE_NOT_RECORDED
## v0.7.14 - 28.05.2026, 13:20:00 EEST
...
## DATE_NOT_RECORDED
## v0.7.13 - 28.05.2026, 13:06:00 EEST
...
## DATE_NOT_RECORDED
## v0.7.12 - 28.05.2026, 12:48:00 EEST
...
## DATE_NOT_RECORDED
## v0.7.11 - 28.05.2026, 12:28:00 EEST
...
## DATE_NOT_RECORDED
## v0.7.10 - 28.05.2026, 12:01:00 EEST
...
## DATE_NOT_RECORDED
## v0.7.9 - 28.05.2026, 10:20:00 EEST
...
## DATE_NOT_RECORDED
## v0.7.8 - 28.05.2026, 10:15:00 EEST
...
## DATE_NOT_RECORDED
## v0.7.7 - 28.05.2026, 10:10:00 EEST
...
## DATE_NOT_RECORDED
## v0.7.6 - 28.05.2026, 10:05:00 EEST
...
## DATE_NOT_RECORDED
## v0.7.5 - 28.05.2026, 10:00:00 EEST
...
## UNVERSIONED - Documentation update
...
## DATE_NOT_RECORDED
## v0.8.24 - Proof-seeded native video selection
...
## DATE_NOT_RECORDED
## v0.8.55 - Raspberry install/runtime blocker repair
...
## DATE_NOT_RECORDED
## v0.8.56 - Raspberry v1.0 release-gate matrix
...
## DATE_NOT_RECORDED
## v0.8.57 - Raspberry three-worker startup smoke proof
...
## DATE_NOT_RECORDED
## v0.8.81 - Fedora parity preflight proofs
...
## DATE_NOT_RECORDED
## v0.8.82 - Fedora parity proof repair
...
## DATE_NOT_RECORDED
## v0.8.83 - Fedora tool parity optional media fix
...
## DATE_NOT_RECORDED
## v0.8.249 - Windows prooflauncher workdir path hotfix
...
## DATE_NOT_RECORDED
## v0.8.250 - Raspberry prooflauncher queue newline hotfix
...
## DATE_NOT_RECORDED
## v0.8.255
- Add real filtered download batch 1 producer proof.
