...
async function main() {
  ...
  const envelope = buildRealIcloudpdReadinessProof({ metadata: await readProjectMetadata(), baseUrl, recentCount: Number.isFinite(recentCount) ? recentCount : 10, cwd: process.cwd() });
