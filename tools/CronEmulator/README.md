...
> Current checkpoint: `v0.10.67`. CronEmulator remains a Windows development/emulation tool only; V2 Startup uses Raspberry real-crontab-oriented controls for the production path.
