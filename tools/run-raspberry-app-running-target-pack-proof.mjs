...
import { buildRaspberryAppRunningTargetPackProof } from './raspberry-app-running-target-pack-lib.mjs';
...
console.log(JSON.stringify({ status: envelope.proof_status, outputPath, stepStatuses: envelope.evidence.step_results.map((step) => ({ id: step.id, reportedStatus: step.reported_status, exitCode: step.exit_code })) }, null, 2));
