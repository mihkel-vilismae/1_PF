...
const envelope = buildOpenSpecV1AuditProof({ metadata: await metadata(), repoRoot: process.cwd() });
const outputPath = await writeProofArtifact('openspec_v1_audit', envelope);
