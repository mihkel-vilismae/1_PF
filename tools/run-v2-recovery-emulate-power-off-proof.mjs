...
const marked = await service.markUncleanShutdown({
  ...
  reason: 'v0.10.86 emulated power-off proof marker; physical proof deferred to v0.10.87',
});
...
check(checks, 'physical-proof-deferred', 'Physical power-loss proof is explicitly deferred to v0.10.87.', true, { deferredTarget: 'v0.10.87' });
