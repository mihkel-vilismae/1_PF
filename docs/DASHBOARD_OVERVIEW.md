...
### Not implemented yet
- backend implementation for the documented API contracts
...
The current implementation mostly uses in-memory mock state, with View A now calling the documented `/api/init/*` contract from the frontend.
