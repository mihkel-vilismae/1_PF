...
| ---: | --- | --- | --- | --- |
| 1 | `B6.1` | `05 TROUBLESHOOTING` pipeline maintenance: Detect issues and Clear stale locks | Completes the maintenance page before recovery/PIR/playback | Placement tests plus stale-lock behavior proof or honest `needs verification` status. |
