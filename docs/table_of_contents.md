...
| `docs/50_audits_and_migrations/DOCS_OPENSPEC_COVERAGE_GRADING_AUDIT_20260616.md` | Current documentation/OpenSpec coverage grading audit, v1 status table, and next documentation-governance fixes. |
