# Real download error classification proof

Command: `npm run proof:real-download-error-classification`

Classifies auth/filter/manifest/no-loop/secret blocked states.
