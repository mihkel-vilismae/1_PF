...
| MF-B3-4-GEOCODER-SEMANTICS | 2026-04-23 | View B / B3.4 (`run-b3-4`) | Open | Geocode stage is backend-backed but remains explicitly deterministic-placeholder geocoder behavior, not full real-equivalent semantics. | `docs/button_verification_results/VIEW_B_B3_4_GEOCODE_STAGE.md`; `server/index.js` (`runtimeGeocodeRunHandler`); `docs/VOICE_AI_AUTHORITATIVE_SPEC_MERGED_2026-04-22.md:194-203`. |
