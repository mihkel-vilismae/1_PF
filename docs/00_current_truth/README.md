...
> Current checkpoint: `v0.10.67`. Current code includes V2 recovery save/load/autosave/restart-check wiring plus the B12 proof gate; live target-machine playback/recovery evidence still overrides stale prose.
