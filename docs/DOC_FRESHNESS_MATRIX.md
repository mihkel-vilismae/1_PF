...
| `CHANGELOG.md` | current_latest_baseline | Forward version log through v0.8.86.a; v0.8.28 is marked superseded by v0.8.29. |
...
| `docs/50_audits_and_migrations/DOCS_OPENSPEC_COVERAGE_GRADING_AUDIT_20260616.md` | current_latest_baseline | Current v0.8.86.a documentation/OpenSpec coverage grading audit, including v1 goal status, local readiness BLOCKED result, and proof/docs drift findings. |
