...
- `docs/proofs/terminal_demo_logs_snapshot_reader_proof.md` — proof for the View `L` read-only snapshot reader states and no-mutation behavior.
- `docs/proofs/terminal_demo_logs_view_overview_proof.md` — proof for the View `L` seven-file overview table.
- `docs/proofs/terminal_demo_logs_detail_panel_proof.md` — proof for the View `L` selected detail panel and bounded preview/tail content.
- `docs/20_architecture_and_specs/openspec/terminal_demo_logs_view_shell_openspec.md` — documents the v2.0.22 View `L` read-only snapshot inspector and registry.
...
- `docs/20_architecture_and_specs/openspec/terminal_demo_view0_custom_test_route_openspec.md` — View 0 custom `7D` test-route contract.
...
| docs/20_architecture_and_specs/reference/BRANCH_HANDOFF_AND_MERGE_CONTRACT.md | 174 | Branch Handoff and Merge Contract | architecture_or_vision_spec | reusable_workflow_contract | current_latest_baseline | 05_vision_and_target_specs | branch_handoff, merge_intake, baseline, proof_pack, truth_labels | Reusable standard for branch ZIP handoff and merge-intake packages; not proof of any specific implementation. |
| docs/50_audits_and_migrations/TERMINAL_DEMO_VIEW0_VIEW6_MERGE_INTAKE_20260702.md | 211 | Terminal Demo View 0 / View 6 Merge Intake - 2026-07-02 | audit_or_migration_report | repo_backed_preimplementation_audit | current_latest_baseline | 08_audits_and_migration_reports | terminal_demo, view0, view6, branch_merge, conflict_matrix, handoff | Pre-implementation intake for two branch artifacts; no target merge or post-merge proof was performed. |
| docs/20_architecture_and_specs/openspec/terminal_demo_shared_logging_openspec.md | 60+ | Terminal Demo Shared Logging OpenSpec | architecture_or_vision_spec | current_contract | current_latest_baseline | 05_vision_and_target_specs | terminal_demo, logging, view0, view6 | Shared terminal action JSONL schema for merged View 0 and View 6 branch features. |
| docs/20_architecture_and_specs/openspec/terminal_demo_view0_default_test_route_openspec.md | 40+ | Terminal Demo View 0 Default Test Route OpenSpec | architecture_or_vision_spec | current_contract | current_latest_baseline | 05_vision_and_target_specs | terminal_demo, view0, route | View 0 default `0A` test-route contract. |
| docs/20_architecture_and_specs/openspec/terminal_demo_view0_custom_test_route_openspec.md | 35+ | Terminal Demo View 0 Custom Test Route OpenSpec | architecture_or_vision_spec | current_contract | current_latest_baseline | 05_vision_and_target_specs | terminal_demo, view0, route | View 0 custom `7D` test-route contract. |
| docs/20_architecture_and_specs/openspec/terminal_demo_view6_fixture_playback_contract_openspec.md | 40+ | Terminal Demo View 6 Fixture Playback Contract OpenSpec | architecture_or_vision_spec | current_contract | current_latest_baseline | 05_vision_and_target_specs | terminal_demo, view6, playback, fixtures | View 6 fixture-backed placeholder contract; no real playback claim. |
| docs/20_architecture_and_specs/openspec/terminal_demo_view6_codex_playback_handoff.md | 40+ | Terminal Demo View 6 Codex Playback Handoff | architecture_or_vision_spec | implementation_handoff | current_latest_baseline | 05_vision_and_target_specs | terminal_demo, view6, playback, handoff | Handoff for later Codex-owned real playback wiring. |
...
| docs/10_runbooks/master_branch_roundtrip_workflow.md | 120+ | Master Branch Roundtrip Workflow | runbook | reusable_workflow_runbook | current_latest_baseline | 10_runbooks | git, branch_handoff, merge_workflow, packaging | Reusable workflow for splitting from `master`, maintaining branch handoff metadata, and uploading sibling branch artifacts together before merge-back. |
