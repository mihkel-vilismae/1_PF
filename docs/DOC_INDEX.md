...
- `docs/50_audits_and_migrations/TERMINAL_DEMO_VIEW0_VIEW6_MERGE_INTAKE_20260702.md` — pre-implementation audit for merging View 0 and View 6 terminal-demo branch artifacts into current `main`; not runtime proof.
