...
| 03_auth_flow_reference | 1 | 72 | Auth/provider verification reference docs. |
| 04_current_status_snapshots | 12 | 889 | Status snapshots; verify against code/evidence; includes Slice 11 root-level dated status snapshots and compatibility pointers. |
