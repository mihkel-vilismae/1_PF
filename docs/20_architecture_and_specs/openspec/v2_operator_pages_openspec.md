...
| Worker/stage card pattern | shared `RPI-STAGES`/`RPI-WORKERS` rows plus V2 Workers B3.1-B3.5 backend cards | `03 STARTUP`, `04 WORKERS`, `05 TROUBLESHOOTING`, `07 PIR`, `08 PLAYBACK`, later `09 REAL PLAYBACK` status summary |
