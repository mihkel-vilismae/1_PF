...
| Worker/stage card pattern | shared `RPI-STAGES` and `RPI-WORKERS` visual rows plus later B3/Test stage cards | `03 STARTUP`, `04 WORKERS`, `05 TROUBLESHOOTING`, `07 PIR`, `08 PLAYBACK`, later `09 REAL PLAYBACK` status summary |
