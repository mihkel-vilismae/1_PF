...
Update note: 2026-05-08 07:25 EEST — docs reconciled after View B pipeline stale-lock maintenance / v0.4.1.
...
- View B runtime buttons call backend endpoints for download, index, GPS, geocode, queue, playback, pipeline orchestration, screen simulation, and stale-lock maintenance, but Stage 1 is mock/generated-data copy and geocode is explicitly deterministic placeholder behavior.
